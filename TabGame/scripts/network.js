...
export function createUpdateEventSource(msg) {
...
// stop EventSource
export function stopUpdateEventSource() {
...
// notify
export async function notify({cell}) {
  const { nick, password, game, cell } = currentState;
...
// ranking
export async function ranking({ group = GROUP, size }) {
