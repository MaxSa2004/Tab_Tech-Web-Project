document.addEventListener("DOMContentLoaded", () => {
  ...
  const modalClassifications = document.getElementById(
    "myModalClassifications"
  );
  ...
  function closeModal(modal) {
    ...
    if (modal._opener && typeof modal._opener.focus === "function")
      modal._opener.focus(); // return focus to opener
  }
  ...
  if (btnInstructions)
    btnInstructions.addEventListener("click", (e) => {
      e.preventDefault();
      openModal(modalInstructions, btnInstructions);
    });
  ...
  function setServerPreference(type) {
    ...
    if (optLocalhost) optLocalhost.classList.remove("selected");
    ...
    if (type === "personal") {
      ...
      if (optLocalhost) optLocalhost.classList.add("selected");
    }
  ...
  if (btn && dropdown) {
    ...
    if (optLocalhost) {
      optLocalhost.addEventListener("click", (e) => {
        e.preventDefault();
        setServerPreference("localhost");
        dropdown.classList.remove("show");
      });
    }
  }
